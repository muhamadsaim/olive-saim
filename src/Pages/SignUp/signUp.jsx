...
const SignUp = () => {
    ...
    const handleSubmit = (e) => {
        ...
        SuccessMessage(`${credentials.name} user created successfully`)
    }
                  ...
                  <div className='inputFields'>
                      ...
                      <form onSubmit={handleSubmit}>
                          <div className='inputDiv'>
                              ...
                              {
                                  !isPhoneNumberValid&&<p style={{color:'red'}}>please enter valid phone</p>
                              }
                              </div>
                          ...
                          <div className='inputDiv'>
                              ...
                              {
                                  !isNameValid&&<p style={{color:'red'}}>please enter valid name</p>
                              }
                              </div>
                          <input type="text" id='name' placeholder='Enter your Name' onChange={(e)=>handleName(e)}  style={{border:isNameValid?'1px solid rgba(144, 166, 123, 1)':'1px solid red'}}/>
                          </div>
                          <div className='inputDiv'>
                              <div className='labelAnderror'><label htmlFor="password">Password</label>
                              <p style={{color:getColor(strength)}}>{strength}</p></div>
                              <div className='passwordDiv' style={{border:`1px solid ${getColor(strength)}`}}>
                                  <input type={showPass?'text':'password'} id='password' placeholder='Enter your password' onChange={(e)=>handlePassword(e)} />
                                  <img src={Eye} alt="passwordShow" onClick={()=>setShowPass(!showPass)}/>
                              </div>
                          </div>
                          <p>By signing up, you are agree to our <span>Terms and Conditions</span> and <span>Privacy Policy</span></p>
                          <input type="submit" value='Continue' className='submit'/>
                      </form>
                      <p>join us before? <Link to='/login'>Login</Link></p>
